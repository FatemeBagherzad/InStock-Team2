        ...
        <div className="container">
            <div className="WarehouseMobDisplay">
                ...
                <div className="WarehouseMobTxt__right">
                    <div className="WarehouseMobTxt__titleAndItem">
                        <p className="WarehouseMobTxt__titleAndItem--label">CONTACT NAME</p>
                        <p className="WarehouseMobTxt__titleAndItem--item ">
                            {warehouse.contact_name}</p>
                    </div>
                </div>
                <div className="WarehouseMobTxt__titleAndItem">
                    <p className="WarehouseMobTxt__titleAndItem--label">CONTACT INFORMATION</p>
                    <p className="WarehouseMobTxt__titleAndItem--item ">
