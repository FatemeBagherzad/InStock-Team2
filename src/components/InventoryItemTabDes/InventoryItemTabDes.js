...
const InventoryItemTabDes = ({ data }) => {
  return (
    <>
      <div className="container inventoryItemTabDesDisplay ">
        <ul className="inventoryItemTabDes">
          <li className="inventoryItemTabDes__li inventoryItemTabDes__li--withIcn">
            {data.item_name}{' '}
            <img
          ...
          <li className="inventoryItemTabDes__li">{data.category}</li>
          ...
          <li className="inventoryItemTabDes__li">{data.quantity}</li>
