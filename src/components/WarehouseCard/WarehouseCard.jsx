  ...
  return (
    <div className="warehouse-card">
      <div className="warehouse-card__text-container">
        <div className="warehouse-card__sub-container">
          ...
          <a className="warehouse-card__link">
            <p className="warehouse-card__content warehouse-card__location">
              Manhattan
            </p>
            <img
        ...
        <div className="warehouse-card__sub-container">
          ...
          <p className="warehouse-card__content warehouse-card__content-mobile">
            Parmin Ahuja
          </p>
          <p className="warehouse-card__content warehouse-card__content-tablet">
      ...
      <div className="warehouse-card__image-container">
        <img
          className="warehouse-card__edit-button"
          src={Delete}
          alt="Delete Icon"
        />
        <img
